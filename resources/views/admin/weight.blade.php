            ...
            <div class="lg:col-span-2">
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.weights.update') }}" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="shadow border border-primary/30 rounded-lg p-4 space-y-3">
                                            <div class="flex justify-between items-start mb-4">
                                                <div>
                                                    ...
                                                    <p class="text-sm text-base-content/70">Code: {{ $criterion->code }}</p>
                                                </div>
                                                <x-badge color="{{ $criterion->type === 'benefit' ? 'success' : 'error' }}" size="sm">
                            ...
                            <div class="alert alert-info">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-base-content/70 mt-1">The system will validate that the sum of all weights equals 1.00 before saving.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 pt-6 ">
                                ...
                                <a href="{{ route('admin.dashboard') }}" class="btn btn-ghost w-full sm:w-auto">
                ...
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-ghost btn-sm w-full justify-start">
