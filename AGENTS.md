...
- **Types**: Use type hints and return types (PHP 8.2+), union types where appropriate
...
- **Testing**: Pest framework with separate Unit/Feature suites, extend TestCase with RefreshDatabase
- **Formatting**: Laravel Pint for PHP, EditorConfig for consistency (4 spaces, LF endings)
- **Frontend**: Alpine.js, Vite for bundling, ES modules